...
export type LeaseContractKind = "empty_primary" | "furnished_primary" | "furnished_student" | "mobility" | "other";
...
export function isLeaseContractKind(value: unknown): value is LeaseContractKind {
  return ["empty_primary", "furnished_primary", "furnished_student", "mobility", "other"].includes(String(value));
}
