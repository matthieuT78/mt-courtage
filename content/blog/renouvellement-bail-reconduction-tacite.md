...
tags: ["renouvellement de bail", "reconduction tacite", "révision du loyer", "loi 1989", "fin de bail", "IRL"]
coverImage: "/blog/renouvellement-bail-reconduction-tacite.jpg"
faq:
  - q: "Qu'est-ce que la reconduction tacite d'un bail ?"
    a: "C'est le mécanisme automatique par lequel un bail arrivé à échéance se poursuit dans les mêmes conditions, pour une durée identique à la durée initiale, dès lors qu'ni le bailleur ni le locataire n'a donné congé dans les formes et délais légaux. Le bailleur n'a rien à signer ni à formaliser : l'absence d'action produit elle-même cet effet (art. 10 loi du 6 juillet 1989)."
  - q: "Le bailleur peut-il augmenter librement le loyer au renouvellement du bail ?"
    a: "Non, sauf exception. La règle générale est la révision annuelle encadrée par l'IRL, identique en cours de bail et au renouvellement. Une réévaluation plus significative n'est possible que si le loyer est manifestement sous-évalué par rapport au marché local, via une procédure spécifique de l'article 17-2, et uniquement hors zone tendue et hors logement classé F ou G au DPE."
  - q: "Combien de temps dure un bail reconduit tacitement ?"
    a: "La même durée que le bail initial : 3 ans pour une location vide avec un bailleur personne physique (6 ans si le bailleur est une personne morale), 1 an pour une location meublée (9 mois pour un bail étudiant meublé, non reconductible tacitement)."
  - q: "Un bailleur peut-il refuser de renouveler le bail sans motif ?"
    a: "Non. Un bailleur ne 'refuse' pas le renouvellement à proprement parler : pour empêcher la reconduction tacite, il doit donner congé dans les formes légales (vente, reprise pour habiter, ou motif légitime et sérieux), avec un préavis de 6 mois avant l'échéance pour un bail vide, 3 mois pour un meublé. Sans congé régulier, le bail se reconduit automatiquement, quelle que soit la volonté du bailleur."
  - q: "Que se passe-t-il si le logement est classé F ou G au DPE au moment du renouvellement ?"
    a: "Le loyer reste gelé : aucune augmentation n'est possible, ni par le mécanisme de révision annuelle IRL, ni par la procédure de réévaluation du loyer sous-évalué, ni lors d'un changement de locataire. Cette interdiction s'applique en France métropolitaine depuis août 2022 pour les logements classés G, et a été étendue progressivement aux classes F."
---

# Renouvellement de bail : reconduction tacite, révision du loyer et ce que peut faire le bailleur

Le bail arrive à échéance dans quelques semaines et personne — ni vous, ni votre locataire — n'a pris l'initiative d'écrire quoi que ce soit. Faut-il s'inquiéter ? Refaire signer un nouveau contrat ? La réponse, dans l'immense majorité des cas, est non : le bail se prolonge automatiquement, sans aucune démarche de votre part. Mais ce mécanisme de reconduction tacite, souvent mal compris, cache plusieurs subtilités que tout bailleur a intérêt à connaître — notamment sur ce qu'il peut, ou ne peut pas, faire évoluer au moment du renouvellement, en particulier concernant le loyer.
