...
tags: ["bail professionnel", "profession libérale", "locaux professionnels", "loi 1986", "bail commercial", "bail mixte"]
coverImage: "/blog/bail-professionnel-guide-2026.jpg"
faq:
  - q: "Un bail professionnel peut-il être signé avec une société ?"
    a: "Oui, sans difficulté. Contrairement au bail d'habitation loi de 1989 qui exige que le logement soit la résidence principale du locataire — ce qu'une personne morale ne peut jamais avoir —, le bail professionnel n'a aucune condition de ce type. Il peut être conclu avec un professionnel en nom propre ou avec une société (SELARL, SCP, SASU, etc.)."
  - q: "Quelle est la différence entre bail professionnel et bail commercial ?"
    a: "Le bail professionnel concerne les professions libérales exerçant une activité non commerciale (médecin, avocat, architecte, consultant...). Le bail commercial concerne les activités commerciales, artisanales ou industrielles (boutique, restaurant, atelier...) et relève du Code de commerce, avec un régime bien plus protecteur pour le locataire (droit au renouvellement, indemnité d'éviction) que le bail professionnel n'offre pas."
  - q: "Peut-on demander un dépôt de garantie de 3 mois de loyer pour un bail professionnel ?"
    a: "Oui. Aucun texte ne plafonne le dépôt de garantie d'un bail professionnel — contrairement au bail d'habitation, limité à 1 ou 2 mois de loyer selon qu'il est nu ou meublé. Le montant est fixé librement par les parties ; l'usage courant se situe entre 2 et 3 mois de loyer hors charges."
  - q: "Le bailleur doit-il facturer la TVA sur un loyer professionnel ?"
    a: "Pas obligatoirement : la location nue à usage professionnel est en principe exonérée de TVA, comme la location d'habitation. Mais le bailleur peut opter pour l'assujettissement à la TVA (article 260, 2° du CGI), ce qui permet de récupérer la TVA sur les travaux et l'entretien de l'immeuble — une option à étudier avec un expert-comptable selon le profil du bien et du locataire."
---

# Bail professionnel : le guide pour louer des locaux à une profession libérale
...
1. **L'identification des parties** — bailleur, locataire (personne physique ou morale), et le cas échéant la mention de la profession exercée.
2. **La désignation précise des locaux** — adresse, superficie, description des lieux, éventuellement un état des lieux annexé (non obligatoire légalement, mais fortement recommandé pour éviter tout litige sur les réparations locatives à la sortie).
3. **La destination des locaux** — la clause la plus importante : elle doit préciser que le local est loué **exclusivement** pour l'exercice de telle activité professionnelle. Une destination trop vague ou une tolérance implicite d'activité commerciale peut exposer le bailleur à une requalification en bail commercial, avec toutes les contraintes que cela implique.
4. **La durée et le point de départ** du bail.
5. **Le loyer, les charges et leurs modalités de révision et de régularisation.**
6. **Le dépôt de garantie** et ses conditions de restitution, éventuellement complété par un [engagement de garant](/blog/garant-locataire-caution-2026) si le locataire débute son activité et ne dispose pas encore d'un historique financier suffisant.
7. **Une clause résolutoire** en cas de manquement grave (défaut de paiement, non-respect de la destination des locaux) — en l'absence de régime légal spécifique comme l'article 24 de la loi de 1989, cette clause relève du droit commun des contrats (résolution pour inexécution, articles 1224 et suivants du Code civil), avec généralement une mise en demeure préalable restée infructueuse pendant un délai fixé au contrat (souvent un mois).
8. **Les diagnostics techniques applicables** — le DPE reste obligatoire pour un local professionnel (avec une méthode de calcul propre aux locaux tertiaires), de même que le constat de risque d'exposition au plomb (immeubles avant 1949), l'état amiante (permis antérieurs à juillet 1997), l'état de l'installation électricité/gaz si elle a plus de 15 ans, et l'état des risques naturels et technologiques selon la zone.
...
*Lokt.fr génère un contrat de bail professionnel conforme (durée, clauses, mentions obligatoires) directement depuis votre [espace bailleur](/outil-gestion-locative), au même titre que les baux d'habitation classiques — y compris lorsque le locataire est une société.*
