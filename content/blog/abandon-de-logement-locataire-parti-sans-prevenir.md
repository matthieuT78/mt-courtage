...
tags: ["abandon de logement", "locataire parti", "commissaire de justice", "loi Alur", "résiliation de bail", "expulsion"]
coverImage: "/blog/abandon-de-logement-locataire-parti-sans-prevenir.jpg"
faq:
  - q: "Un bailleur peut-il reprendre les clés lui-même si le locataire semble parti ?"
    a: "Non, jamais. Même si le logement paraît manifestement vide depuis des mois, reprendre possession sans suivre la procédure légale constitue une violation de domicile, punie d'un an d'emprisonnement et 15 000 € d'amende (article 226-4 du Code pénal), en plus d'exposer le bailleur à devoir indemniser le locataire pour les biens disparus ou détériorés s'il revient."
  - q: "Comment prouver légalement qu'un logement est abandonné ?"
    a: "Par un procès-verbal de constat dressé par un commissaire de justice (ex-huissier), après une mise en demeure restée sans réponse pendant un mois. Ce procès-verbal, encadré par l'article 14-1 de la loi du 6 juillet 1989 (issu de la loi Alur du 24 mars 2014), est le seul moyen légalement reconnu pour établir l'abandon et engager la suite de la procédure."
  - q: "Combien de temps dure la procédure d'abandon de logement ?"
    a: "Comptez généralement 4 à 6 mois entre le premier impayé et la reprise effective des lieux autorisée par le juge : 2 mois de commandement de payer resté sans effet, 1 mois de mise en demeure du commissaire de justice, puis le temps de l'audience devant le juge des contentieux de la protection, généralement plus rapide qu'une procédure d'expulsion classique car souvent non contestée."
  - q: "Que devient le mobilier laissé dans un logement abandonné ?"
    a: "Le commissaire de justice en dresse un inventaire précis lors du constat. Le juge fixe un délai (2 mois minimum) pendant lequel le locataire peut venir le récupérer. Passé ce délai, les meubles ayant une valeur marchande sont vendus aux enchères publiques, et le produit de la vente revient au locataire après déduction des frais ; les objets sans valeur peuvent être détruits."
  - q: "Le bailleur peut-il récupérer les loyers impayés sur le dépôt de garantie en cas d'abandon ?"
    a: "Oui. Le dépôt de garantie s'impute normalement sur les loyers et charges impayés ainsi que sur les dégradations constatées lors de la reprise des lieux, exactement comme pour un départ classique. Si la dette dépasse le dépôt de garantie, le bailleur conserve une créance contre le locataire (et son éventuelle caution), qu'il peut faire valoir ultérieurement s'il le retrouve."
---
...
- **L'[assurance propriétaire non occupant (PNO)](/blog/assurance-pno-proprietaire-non-occupant)** continue en principe de couvrir le logement pendant la vacance, mais il est recommandé de signaler à l'assureur la situation particulière (logement en cours de procédure d'abandon) : certains contrats prévoient des clauses spécifiques ou des exclusions en cas d'inoccupation prolongée non déclarée, notamment au-delà de 90 jours consécutifs.
- **La [garantie loyers impayés (GLI)](/blog/assurance-loyers-impayes-gli-2026)**, si elle a été souscrite, continue généralement d'indemniser les loyers impayés pendant toute la durée de la procédure — mais la plupart des contrats exigent que le bailleur engage sans délai les démarches légales (commandement de payer, puis procédure adaptée) pour continuer à être couvert. Un bailleur qui tarde à agir en pensant que la situation "va se régler d'elle-même" risque de voir sa garantie contestée pour défaut de diligence.
...
| Locataire présent mais ne paie plus | [Procédure d'expulsion classique pour impayés](/blog/expulsion-locataire-procedure) | Commissaire de justice puis tribunal judiciaire |
...
- [Procédure d'expulsion locative](/blog/expulsion-locataire-procedure) — pour un locataire présent mais qui ne paie plus
- [Que faire face à un loyer impayé](/blog/loyer-impaye-que-faire) — les premières démarches avant d'envisager une procédure
- [Dépôt de garantie : restitution et litiges](/blog/depot-de-garantie-restitution-delais-retenues) — comment s'impute la dette locative sur le dépôt

---

*Suivez vos loyers, vos relances et vos alertes de retard en un seul endroit depuis l'[espace bailleur lokt.fr](/outil-gestion-locative) — pour repérer un impayé dès le premier mois, avant que la situation ne se transforme en abandon de logement.*
