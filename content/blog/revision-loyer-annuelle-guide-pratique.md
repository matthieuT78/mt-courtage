...
faq:
  ...
  - q: "La révision de loyer s'applique-t-elle au montant charges comprises ?"
    a: "Non. La formule IRL s'applique uniquement au loyer hors charges. Les provisions pour charges ou le forfait charges restent inchangés (ils obéissent à leur propre régime de régularisation annuelle)."
  - q: "Peut-on rattraper une révision de loyer oubliée plusieurs années ?"
    a: "Non. La loi prévoit un délai d'un an à compter de la date de révision prévue au bail. Passé ce délai, la révision est définitivement perdue pour l'année concernée. On ne peut pas additionner plusieurs années non demandées."
  - q: "Comment notifier la révision de loyer au locataire ?"
    a: "Il n'y a pas de forme imposée par la loi (pas obligatoirement un recommandé). Un email ou un courrier simple suffit, à condition que le message mentionne l'ancien loyer, l'ancien IRL, le nouvel IRL, la formule de calcul, le nouveau loyer et la date d'effet. Conservez toujours une trace de cette notification."
  - q: "Mon logement est classé DPE F : puis-je quand même réviser le loyer ?"
    a: "Non, depuis le 24 août 2022. Les logements classés F ou G sont soumis à un gel des loyers : la révision IRL ne peut pas être appliquée, même si le bail prévoit une clause de révision. Cette règle s'applique en France métropolitaine. Faire des travaux pour passer en E ou mieux est la seule issue pour récupérer le droit de réviser."
  - q: "En zone d'encadrement des loyers, peut-on appliquer la révision IRL normalement ?"
    a: "Oui, mais le loyer révisé ne peut pas dépasser le loyer de référence majoré fixé par la préfecture pour le type de logement concerné. Si la révision IRL amènerait le loyer au-delà de ce plafond, c'est le plafond qui s'applique. Dans la pratique, les loyers encadrés sont souvent déjà proches du plafond."
---

Chaque année, des milliers de bailleurs oublient de réviser leur loyer — ou le font trop tard, sans notification correcte, ou sur la mauvaise base. Résultat : de l'argent définitivement perdu, des relations locataires tendues, ou une révision contestable. Ce guide vous donne le processus complet pour réviser votre loyer en 2026 dans les règles, au bon moment, avec le bon calcul.
...
Pour identifier l'IRL applicable, consultez notre article sur les [valeurs de l'IRL 2026](/blog/irl-indice-reference-loyers-2026) ou directement le site de l'INSEE. Utilisez l'indice du **même trimestre** que celui retenu dans le bail, pour l'année de révision — et comparez-le à l'indice du même trimestre l'année précédente.
...
Utilisez le [calculateur de révision de loyer IRL](/revision-loyer-irl) de lokt.fr pour faire ce calcul automatiquement avec les indices à jour.
...
> *Conformément à la clause de révision prévue au bail signé le [date], je vous informe que le loyer hors charges est révisé selon l'Indice de Référence des Loyers.*
> *Ancien loyer HC : [X] € — IRL de référence [trimestre année] : [ancien IRL]*
> *Nouvel IRL [même trimestre, année N] : [nouvel IRL]*
> *Nouveau loyer HC à compter du [date] : [Y] €*
> *Total mensuel charges comprises : [Z] €*

Utilisez le [modèle de notification de révision de loyer](/modele-notification-revision-loyer) pour générer cette lettre automatiquement, pré-remplie avec vos données.
...
**1. Oublier de notifier dans l'année**
La plus coûteuse. La révision non demandée dans les 12 mois qui suivent la date anniversaire est définitivement perdue. Une alerte automatique dans votre outil de gestion évite ce problème.

**2. Appliquer l'IRL sur le montant charges comprises**
Erreur classique qui gonfle artificiellement la révision et peut être contestée par le locataire. Toujours travailler sur le loyer hors charges.

**3. Utiliser le mauvais trimestre IRL**
Si le bail précise "IRL du 1er trimestre", utiliser l'IRL du 3e trimestre rend la révision contestable. Respectez le trimestre indiqué dans le bail.

**4. Oublier de vérifier le DPE avant révision**
Appliquer une révision sur un logement classé F ou G est illégal depuis août 2022. Si le locataire le découvre, il peut demander remboursement du trop-perçu.

**5. Ne pas conserver la preuve de notification**
Sans trace de la notification (email, courrier), vous ne pouvez pas prouver que le locataire était informé. En cas de litige, c'est votre parole contre la sienne.
...
Depuis l'[espace de gestion locative lokt.fr](/outil-gestion-locative), chaque bail enregistré dispose d'une date d'anniversaire suivie automatiquement. Une alerte vous est envoyée avant l'échéance pour ne jamais manquer la fenêtre de révision. Le [calculateur IRL](/revision-loyer-irl) pré-remplit les indices à jour, génère le message de notification et archive le tout dans le dossier du bail.

---

## Outils pratiques

- [Calculateur de révision de loyer IRL](/revision-loyer-irl) — formule automatique avec les indices à jour
- [Modèle de notification de révision de loyer](/modele-notification-revision-loyer) — lettre conforme à envoyer au locataire
- [Valeurs IRL 2026 : indice de référence des loyers](/blog/irl-indice-reference-loyers-2026) — tableau des indices trimestriels
- [Modèle de mise en demeure pour loyer impayé](/modele-mise-en-demeure-loyer-impaye) — si le locataire refuse le nouveau montant

---

*Gérez vos baux, vos dates de révision et vos alertes d'échéance depuis l'[espace bailleur lokt.fr](/outil-gestion-locative) — pour ne jamais perdre une révision de loyer.*
