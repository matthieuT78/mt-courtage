...
faq:
  - q: "Les frais de notaire sont-ils déductibles des impôts ?"
    a: "Non pour une résidence principale. En revanche, pour un investissement locatif au régime réel, les frais d'acquisition peuvent être amortis ou déduits sur plusieurs années selon le régime fiscal choisi (réel foncier ou LMNP au réel)."
  - q: "Est-ce que deux notaires coûtent plus cher qu'un seul ?"
    a: "Non. Lorsqu'il y a un notaire du vendeur et un notaire de l'acheteur, ils se partagent les émoluments à parts égales. Le coût total pour l'acheteur ne change pas."
  - q: "Peut-on négocier les droits de mutation ?"
    a: "Non. Ce sont des taxes réglementées par la loi. Seule la déduction du mobilier listée dans un inventaire permet de réduire légèrement la base de calcul."
  - q: "Quand paye-t-on les frais de notaire ?"
    a: "À la signature de l'acte authentique (le closing), en général 3 à 4 mois après la promesse de vente. Le notaire demande souvent une provision lors du compromis (environ 5 % du prix), imputée sur les frais définitifs. Si les frais réels sont inférieurs à la provision, le trop-perçu est remboursé sous quelques semaines."
  - q: "Les frais de notaire sont-ils finançables par le crédit ?"
    a: "Oui, certaines banques proposent un prêt à 110 % qui inclut les frais. Mais le taux est souvent moins bon et vous payez des intérêts sur les frais pendant toute la durée du crédit. La majorité des banques exigent au moins les frais de notaire en apport."
---
...
*Intégrez les frais de notaire dans votre simulation de capacité d'emprunt avec notre [calculette capacité d'emprunt](/capacite) — les frais d'acquisition sont pris en compte automatiquement dans le budget total.*
