...
tags: ["encadrement des loyers", "loyer de référence", "complément de loyer", "zone tendue", "fixation du loyer", "sanctions bailleur"]
coverImage: "/blog/encadrement-des-loyers-2026-guide.jpg"
faq:
  - q: "Quelles villes sont concernées par l'encadrement des loyers en 2026 ?"
    a: "En 2026, 72 communes réparties sur 9 territoires appliquent l'encadrement avec loyer de référence : Paris, Lille (avec Hellemmes et Lomme), Lyon et Villeurbanne, Plaine Commune, Est Ensemble, Montpellier, Bordeaux, le Pays basque et Grenoble-Alpes Métropole. D'autres agglomérations (Annemasse, Cergy-Pontoise, Marseille, Nantes) ont engagé des démarches pour le mettre en place."
  - q: "Comment connaître le loyer de référence de mon logement ?"
    a: "Chaque territoire concerné publie un arrêté préfectoral fixant, par zone, nombre de pièces, période de construction et type de location (meublée ou vide), trois loyers de référence au m² : minoré, médian et majoré. Ces montants sont consultables sur le site de l'observatoire local des loyers du territoire concerné, ou sur encadrementdesloyers.gouv.fr pour les territoires qui y sont référencés."
  - q: "Qu'est-ce que le complément de loyer et quand peut-on l'appliquer ?"
    a: "Le complément de loyer permet de dépasser le loyer de référence majoré si le logement présente des caractéristiques exceptionnelles de confort ou de localisation, absentes des logements comparables du même secteur : vue remarquable, prestations haut de gamme, extérieur rare, etc. Un simple bon état d'entretien ou des équipements standards ne suffisent pas. Un logement classé F ou G au DPE ne peut légalement porter aucun complément de loyer."
  - q: "Que risque un bailleur qui dépasse le loyer de référence majoré sans complément justifié ?"
    a: "Le préfet peut le mettre en demeure de se conformer et de rembourser le trop-perçu au locataire, avec un délai de deux mois pour régulariser. En l'absence de mise en conformité, une amende administrative peut être prononcée : jusqu'à 5 000 € pour un bailleur particulier, jusqu'à 15 000 € pour une personne morale (SCI, société)."
  - q: "L'encadrement des loyers s'applique-t-il à tous les biens loués dans ces villes ?"
    a: "Non. Sont notamment exclus : les logements HLM conventionnés, les locations saisonnières de courte durée, et — selon les textes locaux — certains cas de première mise en location ou de logement resté vacant plus de 18 mois, où le loyer peut être fixé plus librement dans certaines limites."
---
...
- [Service-public.fr — Encadrement des loyers](https://www.service-public.fr/particuliers/vosdroits/F31637)
- [Légifrance — Loi n° 2018-1021 du 23 novembre 2018 (loi ELAN)](https://www.legifrance.gouv.fr)
- [encadrementdesloyers.gouv.fr — Simulateurs par territoire](https://www.encadrementdesloyers.gouv.fr)

---

## Outils pratiques

- [Calcul de révision du loyer avec l'IRL](/revision-loyer-irl) — pour la révision annuelle en cours de bail, à combiner avec le plafond de référence si applicable
- [Modèle de notification de révision de loyer](/modele-notification-revision-loyer) — courrier à envoyer au locataire

*Suivez le loyer, les révisions et les échéances de chaque bien de votre parc depuis votre [espace bailleur lokt.fr](/outil-gestion-locative).*
