---
title: "Taux d'endettement immobilier 2026 : règle des 35 %, calcul exact et leviers pour emprunter plus"
...
faq:
  ...
  - q: "Comment calculer son taux d'endettement ?"
    a: "Taux d'endettement = (total des mensualités de crédit en cours + mensualité du nouveau prêt assurance incluse) ÷ revenus nets mensuels × 100. Exemple : 1 100 € de mensualités pour 3 500 € de revenus nets = 31,4 % de taux d'endettement."
  - q: "Les loyers perçus sont-ils pris en compte dans les revenus ?"
    a: "Oui, mais avec une décote. Les banques retiennent généralement 70 % des loyers perçus pour tenir compte des risques de vacance locative, des charges et de la fiscalité. Certaines appliquent la méthode différentielle pour les investisseurs : seule la différence entre mensualité et loyer est comptée dans les charges."
  - q: "Peut-on emprunter avec un taux d'endettement supérieur à 35 % ?"
    a: "Oui, dans certains cas. Les banques disposent d'une enveloppe de dérogation (20 % de leur production). Les profils prioritaires sont les primo-accédants, les revenus élevés avec un reste à vivre confortable et les dossiers avec un apport supérieur à 20 %."
  - q: "Quelle différence entre taux d'endettement et reste à vivre ?"
    a: "Le taux d'endettement est un ratio (charges / revenus). Le reste à vivre est un montant absolu (revenus - charges). Les banques regardent les deux : un taux à 34 % peut être refusé si le reste à vivre est trop faible, et un taux à 36 % peut être accepté si le reste à vivre est très confortable."
  - q: "Comment les banques traitent-elles les revenus des indépendants ?"
    a: "Pour les travailleurs non salariés (TNS, auto-entrepreneurs, professions libérales), les banques calculent généralement la moyenne des revenus sur les 2 à 3 derniers exercices, justifiée par les avis d'imposition. Un seul exercice record ne suffit pas — les banques cherchent la régularité, pas le pic."
---
...
2. Durée du crédit ≤ 25 ans (27 ans en VEFA ou avec travaux représentant au moins 25 % du coût total)
...
C'est la cible prioritaire des dérogations. Les banques sont incitées par le HCSF à privilégier cet usage. Un primo-accédant avec un CDI stable et un apport de 10 % peut souvent obtenir une dérogation jusqu'à 37-38 % d'endettement.

**Revenus élevés avec reste à vivre très confortable**
Un ménage à 10 000 €/mois qui s'endette à 38 % conserve 6 200 €/mois de reste à vivre — aucun risque réel. Les banques traitent ces dossiers avec souplesse.

**Apport supérieur à 20 %**
Un apport élevé réduit le risque pour la banque en cas de revente forcée. C'est un signal fort de gestion financière saine qui justifie une dérogation.

**Patrimoine net positif significatif**
Un emprunteur avec un patrimoine immobilier ou financier important peut obtenir une dérogation car les actifs constituent un filet de sécurité en cas de difficulté.
...
**Le saut de charge**
C'est la différence entre ce que vous payez aujourd'hui (loyer ou mensualité actuelle) et ce que vous paierez après l'achat. Un saut de charge brutal (+600 €/mois d'un coup) est un signal de risque, même si le taux d'endettement reste dans les normes.

**La tenue de compte**
Les banques analysent 3 à 6 mois de relevés bancaires. Des découverts fréquents, des rejets de prélèvements ou une épargne nulle malgré des revenus corrects fragilisent sérieusement un dossier — indépendamment du taux d'endettement.

**La stabilité professionnelle**
Un CDI depuis plus d'un an est le standard. Période d'essai, CDD récent, changement de poste récent sont des points de vigilance. Les indépendants et TNS doivent justifier au minimum 2 à 3 ans d'activité avec des revenus stables.

**L'épargne résiduelle après projet**
Une banque veut voir que vous conservez un matelas financier après l'achat (frais de notaire, déménagement, premiers travaux). Une épargne résiduelle de 3 à 6 mois de mensualités est un signal positif.
...
→ **[Calculez votre capacité d'emprunt sur lokt.fr](/capacite)** — le simulateur intègre vos charges, votre apport et les taux actuels pour estimer votre budget maximal et tester différents scénarios en temps réel.
...
- [HCSF — Recommandation R-HCSF-2021-1 relative à l'octroi de crédits immobiliers résidentiels en France](https://www.banque-france.fr/fr/le-haut-conseil-de-stabilite-financiere-hcsf)
- [Banque de France — Suivi des recommandations du HCSF](https://www.banque-france.fr)
- [Service-public.fr — Crédit immobilier : généralités](https://www.service-public.fr/particuliers/vosdroits/F2441)
- [Légifrance — Arrêté du 29 septembre 2021 relatif aux règles d'octroi de crédits immobiliers](https://www.legifrance.gouv.fr)

---

*Simulez votre capacité d'emprunt et testez l'impact de chaque levier — durée, apport, revenus locatifs — avec notre **[calculateur gratuit](/capacite)**. Résultat en 30 secondes, sans inscription.*
