...
tags: ["quittance de loyer", "reçu de loyer", "obligations bailleur", "gestion locative", "loi du 6 juillet 1989", "quittance électronique"]
coverImage: "/blog/quittance-de-loyer-guide-complet-2026.jpg"
faq:
  - q: "La quittance de loyer est-elle obligatoire ?"
    a: "Elle n'est pas envoyée automatiquement par défaut : la loi du 6 juillet 1989 (article 21) oblige le bailleur à la délivrer gratuitement uniquement si le locataire en fait la demande. En pratique, la plupart des bailleurs l'envoient chaque mois sans attendre la demande, car cela évite les litiges et les relances."
  - q: "Quelle est la différence entre une quittance et un reçu de loyer ?"
    a: "La quittance atteste que le locataire a payé l'intégralité du loyer et des charges pour une période donnée : elle solde la période. Le reçu, lui, ne constate qu'un paiement partiel — il ne solde rien et laisse apparaître un reste dû. Émettre une quittance pour un paiement incomplet est une erreur qui peut se retourner contre le bailleur en cas de litige."
  - q: "Peut-on envoyer une quittance de loyer par email ?"
    a: "Oui, la quittance électronique a la même valeur juridique qu'une quittance papier, à condition que le locataire ne s'y oppose pas explicitement. Un envoi par email avec le PDF en pièce jointe, ou via un espace locataire en ligne, est parfaitement valable et constitue une preuve en cas de litige."
  - q: "Que risque un bailleur qui refuse de délivrer une quittance ?"
    a: "Le locataire peut mettre le bailleur en demeure par lettre recommandée en citant l'article 21 de la loi du 6 juillet 1989. En l'absence de réponse, il peut saisir le tribunal judiciaire, qui peut ordonner la délivrance sous astreinte (une somme due par jour de retard) et accorder des dommages et intérêts si le refus a causé un préjudice réel — par exemple la perte d'une aide au logement."
  - q: "Combien de temps faut-il conserver ses quittances de loyer ?"
    a: "Le délai de prescription des actions relatives aux baux d'habitation est de 3 ans. Il est donc recommandé de conserver ses quittances au moins 3 ans après la fin du bail, aussi bien côté bailleur (preuve de paiement, déclaration fiscale) que côté locataire (justificatif pour la CAF, un bailleur suivant, un employeur)."
---

# Quittance de loyer : mentions obligatoires, modèle et obligations légales 2026
...
1. **L'accord (au moins tacite) du locataire** pour recevoir ses documents par voie électronique — le fait de fournir son adresse email et de ne jamais s'y opposer suffit généralement en pratique
2. **La conservation d'une preuve d'envoi et de réception**, notamment en cas de contestation ultérieure sur la date de délivrance
...
- [Légifrance — Loi n° 89-462 du 6 juillet 1989, article 21](https://www.legifrance.gouv.fr)
- [Service-public.fr — Quittance de loyer](https://www.service-public.fr/particuliers/vosdroits/F1170)
- [ANIL — La quittance de loyer](https://www.anil.org)

---

## Outils pratiques

- [Modèle de quittance de loyer PDF gratuit](/modele-quittance-loyer-pdf) — mentions à jour, paiement complet et reçu partiel
- [Dépôt de garantie : restitution et litiges](/blog/depot-de-garantie-restitution-delais-retenues) — bien distinguer quittance mensuelle et dépôt de garantie

*Générez automatiquement vos quittances chaque mois, dès qu'un loyer est marqué comme encaissé, depuis votre [espace bailleur lokt.fr](/outil-gestion-locative).*
