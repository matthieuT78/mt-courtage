...
faq:
  - q: "Le préavis s'applique-t-il au bailleur qui veut récupérer son bien ?"
    a: "Oui, mais les durées sont différentes. Le bailleur doit respecter 6 mois de préavis avant la fin du bail (location nue) ou 3 mois (meublé), et uniquement pour des motifs légaux : vente du bien, reprise pour y habiter, motif légitime et sérieux."
  - q: "Le locataire peut-il partir avant la fin du préavis ?"
    a: "Oui. Il peut remettre les clés avant la fin du préavis, mais reste redevable du loyer jusqu'à la date de fin — sauf si vous trouvez un nouveau locataire qui entre avant cette date, ou si un accord amiable est conclu."
  - q: "Un locataire peut-il bénéficier d'un préavis de 1 mois en zone non tendue ?"
    a: "Oui, dans des cas précis : perte d'emploi involontaire, mutation professionnelle, premier emploi, bénéficiaire du RSA ou de l'AAH, état de santé justifié par certificat médical, violences conjugales, ou attribution d'un logement social. Un justificatif officiel est obligatoire."
  - q: "Que faire si le locataire ne libère pas les lieux à la fin du préavis ?"
    a: "Si le locataire est encore présent après la fin du préavis sans accord, il est en situation d'occupation sans titre. Vous devez lui envoyer une mise en demeure par recommandé, puis saisir le tribunal judiciaire pour obtenir une ordonnance d'expulsion. La procédure prend généralement 3 à 6 mois."
  - q: "Comment calculer le loyer du dernier mois si le locataire part en milieu de mois ?"
    a: "Le loyer est dû au prorata du nombre de jours occupés. Formule : loyer mensuel divisé par le nombre de jours du mois, multiplié par le nombre de jours occupés. Exemple : loyer de 750 €, départ le 18 juin (18 jours sur 30) = 750 / 30 × 18 = 450 €."
---
...
**Principales villes en zone tendue :**
Paris et toute la petite couronne (92, 93, 94), Lyon, Marseille, Bordeaux, Toulouse, Nantes, Rennes, Lille, Grenoble, Montpellier, Strasbourg, Nice, Toulon, Rouen, ainsi que des dizaines de communes de taille moyenne dans ces agglomérations.
