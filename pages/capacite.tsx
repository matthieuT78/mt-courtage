        ...
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <section className="rounded-2xl border border-slate-200 bg-white shadow-sm p-5 space-y-2">
            ...
            <p className="text-xs text-slate-600 max-w-2xl">
              ...
              futur prêt. Résultat épuré, prêt à être présenté à votre banque
              ou à votre courtier.
            </p>
          </section>
              ...
              {step === 1 && (
                <>
                  ...
                  <p className="text-[0.75rem] text-slate-600">
                    ...
                    locatifs seront pris en compte via vos prêts immobiliers
                    locatifs (70&nbsp;% du loyer).
                  </p>
              ...
              {step === 3 && (
                <>
                  ...
                  <p className="text-[0.75rem] text-slate-600">
                    ...
                    loyer : 70&nbsp;% seront intégrés à vos revenus, comme en
                    banque.
                  </p>
                  {nbCredits === 0 ? (
              ...
              {step === 4 && (
                <>
                  ...
                  <p className="text-[0.75rem] text-slate-600">
                    ...
                    pour estimer votre mensualité, le capital empruntable et un
                    prix de bien.
                  </p>
            ...
            <div className="flex items-start justify-between gap-3">
              <div>
                ...
                <p className="text-[0.75rem] text-slate-600">
                  ...
                  l&apos;analyse détaillée et les autres outils.
                </p>
              </div>
              {hasResult && (
                ...
                <div className="mt-4 rounded-xl border border-dashed border-slate-300 bg-slate-50/80 px-3 py-3 relative overflow-hidden">
                  ...
                  <div className="relative mt-2 flex flex-wrap items-center justify-between gap-2">
                    <p className="text-[0.7rem] text-slate-700 max-w-xs">
                      L&apos;analyse complète (lecture bancaire, scénarios,
                      export PDF, archivage…) est disponible dans la version
                      avancée.
                    </p>
                    <a
