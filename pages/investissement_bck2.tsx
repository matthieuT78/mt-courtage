...
export default function InvestissementPage() {
  ...
  const handleCalculRendement = () => {
    ...
    const texte = [
      ...
      `Coût total du projet (bien + notaire + travaux + agence) : ${formatEuro(coutTotal)}.`,
            ...
            <div className="space-y-3">
              ...
              <div className="rounded-xl bg-slate-50 border border-slate-200 px-3 py-2.5 text-sm text-slate-800">
                ...
                <span className="font-semibold">
                  {formatEuro(
                    prixBien + fraisNotaire + fraisAgence + travaux
                  )}
                </span>
              </div>
            </div>
            ...
            <div className="space-y-3">
              ...
              <div className="space-y-1">
                <label className="text-xs text-slate-700 flex items-center gap-1">
                  ...
                  {hasAirbnb && (
                    <InfoBadge text="Pour la location saisonnière, ce champ représente les frais de conciergerie (10–25 %). Pour la longue durée, il couvre les frais de gestion locative si vous déléguez." />
                  )}
                </label>
                <input
                  type="number"
        ...
        {onglet === "credit" && (
          <section className="rounded-2xl border border-slate-200 bg-white shadow-md p-5 space-y-4">
            <div>
              ...
              <p className="text-xs text-slate-500">
                Apport personnel, taux et durée du crédit.
              </p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mt-3">
              <p className="text-xs text-slate-500">
                ...
                rentabilité dans l&apos;onglet “Résultats & dashboard”.
              </p>
              <button
                onClick={() => setOnglet("resultats")}
                ...
                <div className="grid gap-4 lg:grid-cols-2">
                  <div className="rounded-xl bg-slate-50 border border-slate-200 p-3">
                    <p className="text-xs text-slate-600 mb-2">
                      Flux annuels : loyers bruts, charges, crédit et résultat
                      net.
                    </p>
                    {barData && (
                      <Bar
