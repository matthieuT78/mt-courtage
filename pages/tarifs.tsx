  ...
  return (
    <div className="min-h-screen bg-[#f6f9fc] flex flex-col">
      ...
      <main className="flex-1">
        ...
        <section className="px-4 pb-2 pt-2 sm:pt-4">
          <div className="mx-auto max-w-6xl">
            <div data-scroll-reveal data-reveal-delay="0" className="overflow-hidden rounded-[1.5rem] border border-slate-200 bg-white shadow-sm sm:rounded-[1.75rem]">
              <div className="px-4 py-5 sm:px-6 sm:py-6">
                ...
                <h2 className="mt-1 font-semibold leading-tight text-slate-950">
                  <span className="block text-xl sm:text-2xl">0 % de commission sur votre loyer.</span>
                </h2>
