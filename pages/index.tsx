...
export default function Home() {
  ...
  const handleCalculCapacite = () => {
    ...
    setResumeCapacite({ mensualiteMax, capital });
    setLastSimu("capacite");
  };
    ...
    <div className="min-h-screen flex flex-col bg-slate-100">
      ...
      <main className="flex-1 max-w-6xl w-full mx-auto px-4 py-6">
        <div className="grid gap-6 lg:grid-cols-2">
          ...
          <section className="rounded-2xl border border-slate-200 bg-white shadow-[0_18px_40px_rgba(15,23,42,0.08)] p-5">
            ...
            <p className="text-xs text-slate-500 mb-4">
              Renseignez vos revenus, vos crédits en cours et vos loyers existants pour obtenir une vision proche d&apos;une analyse bancaire.
            </p>
                        ...
                        {c.type === "immo" && (
                          <div className="mt-2 space-y-1">
                            ...
                            <p className="text-[0.65rem] text-slate-500">
                              Seuls 70 % de ce loyer sont retenus dans le calcul pour refléter une approche bancaire prudente.
                            </p>
                          </div>
                        )}
                      </div>
          ...
          <section className="rounded-2xl border border-slate-200 bg-white shadow-[0_18px_40px_rgba(15,23,42,0.08)] p-5">
            ...
            <p className="text-xs text-slate-500 mb-4">
              Renseignez le montant du projet, le nombre d&apos;appartements et les loyers envisagés pour obtenir une vision globale du rendement et du cash-flow.
            </p>
        ...
        <section className="mt-8 space-y-6">
          <div className="rounded-2xl border border-slate-200 bg-white shadow-[0_24px_60px_rgba(15,23,42,0.12)] p-6 print:bg-white print:text-black print:shadow-none">
            ...
            <div className="mt-4 border-t border-slate-200 pt-4 space-y-5 print:border-t print:border-slate-300">
              {lastSimu === null && (
              ...
              {/* Carte de résumé mise en avant */}
              {lastSimu === "capacite" && resumeCapacite && (
                <div className="rounded-2xl border border-sky-100 bg-sky-50 px-4 py-3 flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
                  <div>
                    <p className="text-[0.7rem] uppercase tracking-[0.18em] text-sky-700 mb-1">
                      Synthèse capacité
                    </p>
                    <p className="text-xs text-slate-600">
                      En tenant compte de vos revenus, crédits en cours et loyers existants.
                    </p>
                  </div>
                  <div className="flex flex-wrap gap-4 md:gap-8">
                    ...
                    <div>
                      ...
                      <p className="text-lg font-semibold text-slate-900">
                        {formatEuro(resumeCapacite.capital)}
                      </p>
                    </div>
                  </div>
                </div>
              ...
              {lastSimu === "rentabilite" && resumeRendement && (
                <div className="rounded-2xl border border-emerald-100 bg-emerald-50 px-4 py-3 flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
                  <div>
                    <p className="text-[0.7rem] uppercase tracking-[0.18em] text-emerald-700 mb-1">
                      Synthèse investissement locatif
                    </p>
                    <p className="text-xs text-slate-600">
                      Cash-flow et rentabilité estimés sur la base des hypothèses saisies.
                    </p>
                  </div>
                  <div className="flex flex-wrap gap-4 md:gap-8">
                    <div>
              ...
              {lastSimu === "rentabilite" && graphData && barData && (
                <div className="rounded-xl bg-slate-50 border border-slate-200 p-3 print:bg-white print:border-slate-300">
                  <p className="text-xs text-slate-600 mb-2 print:text-slate-700">
                    Vue d’ensemble des flux annuels (loyers, charges, crédit, résultat net).
                  </p>
                  <Bar
                    data={barData}
                    options={{
              ...
              <p className="mt-1 text-[0.68rem] text-slate-500 print:text-[0.7rem] print:text-slate-700">
