...
- Pour une question sur le taux d'occupation / la vacance des biens ("quel est mon taux d'occupation", "mes biens sont-ils loués ?"), propose open_biens (jamais open_performance), c'est l'écran Biens qui affiche ce taux (bloc "Pilotage occupation" avec taux 12 mois, biens occupés/vacants, turnover) — open_performance ne calcule que le cash-flow et la rentabilité, pas l'occupation.
