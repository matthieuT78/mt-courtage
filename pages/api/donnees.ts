...
export const DONNEES_IMMO = {
  meta: {
    source: "lokt.fr",
    description: "Données immobilières de référence France — loyers médians, rendements, taux de crédit, capacité d'emprunt. Mise à jour trimestrielle.",
    periode: "T2 2026",
    sources_externes: [
  ...
  taux_endettement: {
    ...
    note: "Taux calculé charges totales incluses (assurance emprunteur comprise), selon la norme HCSF en vigueur.",
  },
  capacite_emprunt_reference: {
    description: "Capacité d'emprunt indicative par tranche de revenus nets mensuels, sans autres charges, taux 3,5 % hors assurance",
    unite: "€",
    hypotheses: { taux_endettement_cible: 35, taux_credit: 3.5, assurance: 0.36 },
    donnees: [
      { revenus_nets_mensuels: 2000, mensualite_max: 700, capital_20_ans: 121000, capital_25_ans: 140000 },
      { revenus_nets_mensuels: 3000, mensualite_max: 1050, capital_20_ans: 181000, capital_25_ans: 210000 },
      { revenus_nets_mensuels: 4000, mensualite_max: 1400, capital_20_ans: 241000, capital_25_ans: 280000 },
      { revenus_nets_mensuels: 5000, mensualite_max: 1750, capital_20_ans: 302000, capital_25_ans: 349000 },
      { revenus_nets_mensuels: 6000, mensualite_max: 2100, capital_20_ans: 362000, capital_25_ans: 419000 },
      { revenus_nets_mensuels: 8000, mensualite_max: 2800, capital_20_ans: 483000, capital_25_ans: 559000 },
      { revenus_nets_mensuels: 10000, mensualite_max: 3500, capital_20_ans: 604000, capital_25_ans: 699000 },
    ],
  },
  ...
  rendements_locatifs_par_type: {
    ...
    unite: "% annuel brut",
    note: "Rendement brut = loyers annuels / prix d'achat (frais de notaire inclus). Le rendement net est inférieur de 1,5 à 2 points après charges.",
    donnees: [
...
export default function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  if (section && typeof section === "string") {
    const key = section as keyof typeof DONNEES_IMMO;
    if (DONNEES_IMMO[key]) {
      return res.status(200).json(DONNEES_IMMO[key]);
    }
    return res.status(404).json({ error: `Section '${section}' introuvable. Sections disponibles : ${Object.keys(DONNEES_IMMO).join(", ")}` });
  }

  return res.status(200).json(DONNEES_IMMO);
}
