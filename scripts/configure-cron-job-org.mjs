...
// cron-job.org est la référence pour la planification (Vercel Cron est
// limité selon le plan) — ces entrées sont aussi dupliquées dans
// vercel.json pour certains jobs, en filet de sécurité.
const jobs = [
  {
