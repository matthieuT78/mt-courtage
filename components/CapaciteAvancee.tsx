// components/CapaciteAvancee.tsx
...
export function CapaciteAvancee() {
      ...
      <div className="rounded-2xl border border-slate-200 bg-white shadow-md p-5 space-y-4">
        <div>
          ...
          <h2 className="text-lg font-semibold text-slate-900">
            Situation complète & paramètres du crédit
          </h2>
          <p className="text-xs text-slate-500">
            Version détaillée prenant en compte vos crédits en cours et 70 % des
            loyers pour les investissements locatifs, comme le font les banques.
          </p>
        </div>
                  ...
                  {typesCredits[index] === "immo" && (
                    <div className="space-y-1">
                      ...
                      <p className="text-[0.65rem] text-slate-500">
                        70 % de ce loyer sera intégré à vos revenus, comme en
                        analyse bancaire.
                      </p>
                    </div>
                  )}
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              ...
              <div className="rounded-xl bg-slate-50 border border-slate-200 px-3 py-2.5">
                ...
                <p className="mt-1 text-[0.7rem] text-slate-500">
                  Incluant frais de notaire (~7,5 %) et d&apos;agence (~4 %) dans
                  le financement.
                </p>
              </div>
              <div className="rounded-xl bg-slate-50 border border-slate-200 px-3 py-2.5">
