  ...
  const computeAll = () => {
    ...
    if (capaciteMensuelle > 0 && n > 0) {
      if (i === 0) montantMax = capaciteMensuelle * n;
        ...
        montantMax = capaciteMensuelle * ((facteur - 1) / (i * facteur));
      }
    }
              ...
              <div className="grid gap-3 sm:grid-cols-2">
                <div className="space-y-1">
                  ...
                  <input
                    ...
                    onChange={(e) => setRevenusNetMensuels(parseFloat(e.target.value) || 0)}
                    className="w-full rounded-lg border border-slate-300 bg-white px-3 py-2 text-sm text-slate-900 focus:outline-none focus:ring-1 focus:ring-emerald-500"
                  />
                </div>
                ...
                <div className="space-y-1">
                  ...
                  <input
                    ...
                    onChange={(e) => setAutresRevenusMensuels(parseFloat(e.target.value) || 0)}
                    className="w-full rounded-lg border border-slate-300 bg-white px-3 py-2 text-sm text-slate-900 focus:outline-none focus:ring-1 focus:ring-emerald-500"
                  />
                </div>
              </div>
          ...
          {step === 5 && (
            <>
              ...
              <div className="grid gap-3 sm:grid-cols-3">
                <div className="space-y-1">
                  <label className="text-[0.7rem] text-slate-700">Taux du crédit (annuel, %)</label>
                  <input
                    type="number"
